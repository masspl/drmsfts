            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url() ?>monitoringChapter">Monitoring Chapter</a><span class="divider-last">&nbsp;</span></li>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo base_url() ?>monitoringChapter/createChapter" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="">
