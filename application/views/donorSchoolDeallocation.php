                            ...
                            <form action="<?php echo base_url() ?>donor/mapDonorSchool" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="">
                              ...
                              <table class="table control-group">
                                ...
                                <thead style="border: 2px solid black;">
                                  <tr>
                                    <th>Select All<input type="checkbox" id="select-all" name="" value="" checked></th>
                                    <th>Sl.No</th>
                                    <th>School Name</th>
                                    <th>School Code</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type='checkbox' id='checkbox'  checked name='' value="<?php echo $value['msd_school_code']?>" ></td>
                                        <td><?php echo  $i ?></td>
...
<script type="text/javascript">
    ...
    $(".confirmsubmit").click(function() {
       $.ajax({
                ...
                data: {'schoolData': window.schoolData, 'donor': ''},
                type: 'POST', 
