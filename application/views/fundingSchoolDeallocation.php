                        ...
                        <div class="widget-body form">
                            ...
                            <form action="#" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="">
                             ...
                             <table class="table control-group">
                                ...
                                <thead style="">
                                  <tr>
                                    <th>Select<input type="checkbox" id="select-all" name="" value="" checked></th>
                                    <th>Sl.No</th>
                                    <th>School Name</th>
                                    <th>School Code</th>
                                    <th>State</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type='checkbox' id='checkbox' checked name='check' value="<?php echo $value['msd_school_code']?>" style="opacity: 1 !important;"></td>
                                        <td><?php echo  $i ?></td>
    ...
    $("#submit").click(function() {
     ...
     $(".confirmsubmit").click(function() {
       $.ajax({
                ...
                data: {'schoolData': window.schoolData, 'fundingchapter': ''},
                type: 'POST', 
