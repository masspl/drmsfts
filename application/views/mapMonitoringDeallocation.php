    ...
    <div id="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        Monitoring Chapter Deallocation
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo base_url() ?>monitoringChapter/findMonitoringSchool/" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="">
