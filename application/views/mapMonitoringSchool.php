    ...
    <div id="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="page-title">
                        Monitoring Chapter Allocation
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <a href="<?php echo base_url() ?>drm#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                        </li>
                        <li><a href="<?php echo base_url() ?>fundingChapter/mapFunding/">MC Allocation</a><span class="divider-last">&nbsp;</span></li>
                            ...
                            <form action="#" class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="">
                             ...
                             <div class="control-group">
                                  ...
                                  <span class="fundingChapterDesc" style="font-weight: bold;" id="donordesc"> <?php echo $monitoringchapter[0]['mmc_desc']; ?> </span>
                                    <input type="text" name="fundingchapter" value="<?php echo $monitoringchapter[0]['mmc_id']?>" id="fundingchapterid" style="display: none;">
                              </div>
                              <div class="control-group">
...
<script type="text/javascript">
    ...
    $("#submit").click(function() {
        ...
        window.monitoringchapter =$('#fundingchapterid').val();
     ...
     $(".confirmsubmit").click(function() {
       $.ajax({
                url: BASE_URL+"monitoringChapter/uploadMonitoringChapter",
                data: {'schoolData': window.schoolData, 'monitoringchapter': window.monitoringchapter},
                type: 'POST', 
