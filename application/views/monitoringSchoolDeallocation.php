            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url() ?>monitoringChapter/mcDeallocation">MC Deallocation</a><span class="divider-last">&nbsp;</span></li>
    ...
    $("#submit").click(function() {
     ...
     $(".confirmsubmit").click(function() {
       $.ajax({
                ...
                data: {'schoolData': window.schoolData, 'monitoringchapter': ''},
                type: 'POST', 
